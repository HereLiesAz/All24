...
export const Home: React.FC = () => {
  return (
    <div className="space-y-12 pb-8 animate-in fade-in slide-in-from-bottom-4 duration-1000 perspective-1000">
      ...
      {/* Header Photo */}
      <div className="w-full h-48 sm:h-64 overflow-hidden relative border-b-2 border-[var(--accent-p)] shadow-[0_0_20px_var(--accent-p)] group transform-style-3d">
        <img
        ...
        <div className="absolute bottom-4 left-4 translate-z-20 group-hover:translate-z-30 transition-transform duration-[1500ms]">
             <h2 className="text-4xl font-glitch leading-none text-white uppercase glitch-text drop-shadow-[0_0_15px_var(--accent-c)] animate-float">
